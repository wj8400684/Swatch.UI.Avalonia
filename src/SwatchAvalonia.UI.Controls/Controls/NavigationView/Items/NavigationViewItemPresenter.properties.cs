...
public partial class NavigationViewItemPresenter
{
    ...
    public static readonly StyledProperty<IconSource> IconSourceProperty =
        AvaloniaProperty.Register<NavigationViewItemPresenter, IconSource>(nameof(IconSource));
    ...
    public static readonly StyledProperty<InfoBadge> InfoBadgeProperty =
        AvaloniaProperty.Register<NavigationViewItemPresenter, InfoBadge>(nameof(InfoBadge));
